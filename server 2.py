...
class Bot():
    def __init__(self):
        pub_secret_key = "SBY5C6EXCQHCDA7VYZWH637R7TXGPP253NDG7B7UDDHFWFQJCH7XNAPE"
        TRANSACTION_TIMEOUT = 12 # seconds, how long should it wait for transaction
        self.BASE_FEE = 10000
        from_asset = Asset('AQUA', 'GBNZILSTVQZ4R7IKQDGHYGY2QXL5QOFJYQMXPKWRRM5PAV7Y4M67AQUA')
        dest_asset = Asset('USDT', 'GA24LJXFG73JGARIBG2GP6V5TNUUOS6BD23KOFCW3INLDY5KPKS7GACZ')
