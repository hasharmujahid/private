...
class Bot():
    def __init__(self):
        ...
        TRANSACTION_TIMEOUT = 18 # seconds, how long should it wait for transaction
        self.BASE_FEE = 10000
        from_asset = Asset('LSP', 'GAB7STHVD5BDH3EEYXPI3OM7PCS4V443PYB5FNT6CFGJVPDLMKDM24WK')
        dest_asset = Asset('MINTO', 'GD5K5YJZTP45T6C7C7JAAW4V2H7XLQBFL3I243NTCIXADPACFHH7XJLR')
